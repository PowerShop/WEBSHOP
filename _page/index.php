  ...
  <div class="card text-white bg-primary mt-2">
    ...
    <div class="card-body">
      ...
      <?php
                ...
                ?>
      <p class="card-text"><i class="fa fa-user-circle" aria-hidden="true"></i> ผู้ใช้ : <?php echo $pdo['username'];  ?></p>
      <p class="card-text"><i class="fa fa-money" aria-hidden="true"></i> พอยท์คงเหลือ : <?php echo $pdo['point']; ?></p>
    </div>
  </div>
                  <?php }} ?>
  <div class="card mt-2">
    ...
    <div class="card-body">
      ...
      <p class="card-text"><i class="fa fa-rss" aria-hidden="true"></i> สถานะเซิร์ฟเวอร์ <?php if($api->status->status == "Online"){ echo "<button class='btn btn-success'>Online</button>"; }else{ echo "<button class='btn btn-danger'>Offline</button>"; }?></p>
      <p class="card-text"><i class="fa fa-users" aria-hidden="true"></i> จำนวนผู้เล่นออนไลน์ <button class="btn btn-warning"><div id="screen">กำลังโหลดจำนวนผู้เล่น...</div></button></p>
    </div>
  </div>
  <div class="card mt-2">
    <img class="card-img-top" alt="">
